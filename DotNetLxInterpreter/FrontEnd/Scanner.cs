...
public class Scanner(string source)
{
    ...
    private void ScanToken()
    {
        ...
        switch (currentChar)
        {
            ...
            default:
                ...
                DotNetLx.ReportError(_line, _current - _columnStartOffset, $"Unrecognized character '{currentChar}'");
                break;
        }
    }
    ...
    private void ExtractStringLiteral()
    {
        ...
        if (IsAtEnd())
        {
            DotNetLx.ReportError(_line, _current - _columnStartOffset, "Unterminated string.");
